...
export default function PrescriptioComponent() {
  ...
  return (
    <div className="max-w-2xl mx-auto mt-8 p-8 bg-gradient-to-br from-blue-50 to-pink-50 rounded-2xl shadow-xl border-2 border-blue-100/50 backdrop-blur-sm">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-pink-100 hover:shadow-md transition-all duration-300">
          <span className="text-sm font-medium text-pink-600 mb-1 block">รหัสผู้ป่วย</span>
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-pink-100 hover:shadow-md transition-all duration-300">
          <span className="text-sm font-medium text-pink-600 mb-1 block">ประเภทผู้ป่วย</span>
        ...
        <div className="bg-white/70 backdrop-blur-sm rounded-xl p-4 border border-pink-100 hover:shadow-md transition-all duration-300 md:col-span-2">
